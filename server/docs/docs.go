        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "clickhouse_sinker_nali": {
                    "description": "Clickhouse_Sinker",
                    "$ref": "#/definitions/config.ClickhouseSinker"
                },
                "email": {
