...
var files = []example.ExaFileUploadAndDownload{
	{global.GVA_MODEL{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "笑脸.png", "https://suifengdang.club/dl/xiao.jpeg", "png", "158787308910.png"},
	{global.GVA_MODEL{ID: 2, CreatedAt: time.Now(), UpdatedAt: time.Now()}, "大肚腩.png", "https://suifengdang.club/dl/dadunan.jpeg", "png", "1587973709logo.png"},
}
